  ...
  return (
    <ScrollView
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput style={styles.input} placeholder="New screening question" />
        <View style={styles.radioView}>
          <TouchableOpacity onPress={() => setScreeningQues('saveForLater')}>
            {screeningQues === 'saveForLater' ? (
              <Fontisto name="radio-btn-active" size={20} color={Color.blue} />
            ) : (
              <Fontisto
        ...
        <View style={styles.applyJobOnView}>
          ...
          <Text style={styles.p2}>
            Candidate apply for a job on your website, all applications on your
            own website
          </Text>
        </View>
        <Text style={styles.h1}>Apply for Job On</Text>
